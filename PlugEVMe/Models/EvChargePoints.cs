...
// I didn't both with decoriating any of these classes with [AddINotifyPropertyChangedInterface],
// but if you'd like these classes to emit PreoprtyChanaged events, that's all you need to do: add the [AddINotifyPropertyChangedInterface] attribute.
